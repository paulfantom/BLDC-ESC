//-----------------------------------------------------------------------------
// F330_100A_BL_ESC_STEP_5P.c "BEMF + Zero cross control" with Pull-up while PWM off
//-----------------------------------------------------------------------------
...
#define BEMF_DUTY_INC_TIMING 50	// BEMF power step up increasing timing frame on Timer 2
...
#define REAR_EDGE_TO_ZC_POINT 6
...
#define IND_KICK_TIME_CHECK 3	// 490nS x 255 x this value
...
#define CHECK_ZC_AT_PWM_ON_DUTY STICK_RESOLUTION*95/100
...
*/
		...
		case 2:
		P0 |= 0x40;	// #01000000 	; //UH
		P1 &= 0x0e;	// #00001110b	; UL(P1.0)="L", VH(P1.4)="L", VL(P1.5)="L", WH(P1.6)="L", WL(P1.7) ="L"
		break;

		case 3:
		case 4:
		P0 &= 0xbf;	// VH	
		P1 &= 0x1e;	// mov P1, #00011110b	; UL(P1.0)="L", VH(P1.4)="H", VL(P1.5)="L", WH(P1.6)="L", WL(P1.7) ="L"	
		break;
		...
		P0 &= 0xbf;	// WH	
		P1 &= 0x4e;	// #01001110b	; UL(P1.0)="L", VH(P1.4)="L", VL(P1.5)="L", WH(P1.6)="H", WL(P1.7) ="L"
		break;
	}
}
